...
var units = (function () {
  ...
  //         = 0                  # settlers
  var units = [
  [ {off:50, def_i:40, def_c:55, speed:7, cost:[  100,   80,  130,   30], cu:1, time: 2000, cap:50,  type:'i', prod: 20, mask:5, rs_time:7800},
  ...
  [ {off:40, def_i:20, def_c:5,  speed:7, cost:[   95,   75,   40,   40], cu:1, time:  900, cap:60,  type:'i', prod: 20, mask:1, rs_time:4500},
    ...
    {off:90, def_i:100,def_c:40, speed:14,cost:[  370,  270,  290,   75], cu:2, time: 3000, cap:110, type:'c', prod: 21, mask:6, rs_time:10800},
